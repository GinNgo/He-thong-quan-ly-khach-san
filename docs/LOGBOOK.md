...
|:---:|:---|:---|:---|:---:|
| **1** | Tuần 1 | - Nhận đề tài từ GVHD.<br>- Tìm hiểu và phân tích các quy trình nghiệp vụ thực tế của một khách sạn.<br>- Xác định các yêu cầu chức năng (Functional) và phi chức năng (Non-functional) cơ bản. | Bảng danh sách yêu cầu hệ thống cơ bản (Business Requirements). | |
