...
| T278 / PUB-010 | Pending task commit | Backend 19/19, frontend 28/28, Angular development build PASS and real-backend Playwright 3/3; one eligible room satisfies inclusive bounds, availability, displayed pricing and price sorting, while the price chip resets page one without losing query state | Mark T278 complete in shared `tasks.md`; mirror PUB-010 `COMPLETE_VERIFIED` and the T278 evidence link into both shared inventory matrices. |
