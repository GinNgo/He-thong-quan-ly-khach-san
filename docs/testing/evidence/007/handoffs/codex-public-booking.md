...
| T274 / PUB-006 | Pending task commit | Backend focused 16/16; Angular query/serializer 11/11; development build PASS; API-backed Playwright 3/3; explicit query allowlist, invalid-date UI and eligibility sentinels verified | Mark T274 complete in shared `tasks.md`; mirror PUB-006 `COMPLETE_VERIFIED` and the T274 evidence link into both shared inventory matrices. |
