...
|---|---|---|---|
| T277 / PUB-009 | `BLOCKED_POLICY_AND_PARALLEL_SCOPE` | [T277 stop-gate evidence](../remediation/T277-public-offer-policy-stop-gate.md); T255 amenity implementation exists on `codex/property-operations` at `69d16c0` | Do not mark T277 complete. Converge T255 first, then obtain approved cancellation/refund/no-show, breakfast-inclusion and pay-at-property rules before resuming T277. |
