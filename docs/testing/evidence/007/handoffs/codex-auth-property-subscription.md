...
|---|---|---|---|---|
| T228 | COMPLETE_VERIFIED | Pending task commit | Backend 5/5; frontend 6/6; `git diff --check` | Mark T228 complete in Feature 007 `tasks.md`; merge AUTH-020 status/evidence into the two shared aggregate inventories. |
