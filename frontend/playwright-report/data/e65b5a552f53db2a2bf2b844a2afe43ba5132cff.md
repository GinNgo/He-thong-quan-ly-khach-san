...
- Name: home-search.spec.ts >> Home Search Redesign >> should toggle stay type to day-use
- Location: e2e\home-search.spec.ts:40:7
...
Call log:
  - waiting for getByText('Chỗ Ở Trong Ngày')
    - locator resolved to <span class="text-[14px] font-semibold text-gray-600">Chỗ Ở Trong Ngày</span>
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e3]:
      ...
      - button "" [ref=e227] [cursor=pointer]:
        - generic [ref=e228]: 
  - generic [ref=e231]:
    - generic [ref=e232]: "TS2339: Property 'moduleId' does not exist on type 'PageRowData'. Property 'moduleId' does not exist on type 'AppModule & { type: PageEntityType; }'."
    - generic [ref=e233]: src/app/features/system/module-management/module-management.ts:136:21
    - generic [ref=e234]: Click outside, press Esc key, or fix the code to dismiss.
```
