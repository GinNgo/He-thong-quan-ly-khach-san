...
- Name: home-search.spec.ts >> Home Search Redesign >> should display the hero search panel with default values
- Location: e2e\home-search.spec.ts:9:7
...
Locator: locator('app-location-autocomplete input')
Expected: visible
Error: strict mode violation: locator('app-location-autocomplete input') resolved to 2 elements:
