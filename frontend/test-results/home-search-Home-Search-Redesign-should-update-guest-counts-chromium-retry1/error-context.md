...
- Name: home-search.spec.ts >> Home Search Redesign >> should update guest counts
- Location: e2e\home-search.spec.ts:49:7

# Error details

```
Error: locator.click: Error: strict mode violation: locator('app-guest-room-selector') resolved to 2 elements:
    1) <app-guest-room-selector _ngcontent-ng-c141084617="">…</app-guest-room-selector> aka locator('app-sticky-search-bar app-guest-room-selector')
    2) <app-guest-room-selector>…</app-guest-room-selector> aka locator('app-hero-search app-guest-room-selector')

Call log:
  - waiting for locator('app-guest-room-selector')
