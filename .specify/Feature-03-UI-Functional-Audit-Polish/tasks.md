...
- [ ] T051 [US5] Reduce the production initial bundle below its configured budget and resolve or document the `@stomp/stompjs`, `sockjs-client` and inline-font warnings per SC-010/GAP-017 (partial)
